...
const remainingName = APP_DATA.owner.slice(1);
    ...
    return (
        <section className='relative min-h-screen  flex items-center overflow-hidden'>
                ...
                <div className='px-7  flex flex-col items-center gap-8 sm:flex-row  w-screen '>
                    ...
                    <div className='px-10 relative '>
                        <img
                            ...
                            alt="Profile"
                            className='mx-auto animate-fade-in object-cover border-4 border-white/10
            w-70 h-auto
            sm:w-80 sm:h-auto
            md:w-90 md:h-auto
            lg:w-100 lg:h-auto
            ...
            shadow-[0_0_20px_rgba(0,194,255,0.6)]
            [border-radius:60%_40%_30%_70%/60%_30%_70%_40%]'
                        ...
                        <div className='absolute bottom-4 right-4 glass rounded-xl px-4 py-3 animate-float animation-delay-400'>
                            <div className="flex items-center gap-3 ">
                                <div className='w-3 h-3 bg-[var(--color-baseColor)] rounded-full animate-pulse'></div>
